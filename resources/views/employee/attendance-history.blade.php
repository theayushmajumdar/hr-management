...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadGoogleMapsAPI() {
        return new Promise((resolve, reject) => {
            ...
            script.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBzMn3uVdk_wFU9wxcySb1mTDEAeNXx6Cs&libraries=places';
            script.async = true;
            script.defer = true;
    ...
    // Initialize map tooltips after API is loaded
    ...
    // Load Google Maps API and initialize tooltips
    loadGoogleMapsAPI()
